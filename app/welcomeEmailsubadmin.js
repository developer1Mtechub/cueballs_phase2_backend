...
const WelcomeEmailSubadmin = async (email, subject, password) => {
            ...
            <div style="display: block; text-align: center; margin-top:40px">
              <div
                ...
                <p
                  ...
                  <br>
                  <br>
                  <span style="font-weight: 600;color: #F5BC01;">Email : ${email}</span>
                  <br>
                  <span style="font-weight: 600;color: #F5BC01;">Password : ${password}</span>
                  <br>
                  <br>
...
module.exports = WelcomeEmailSubadmin;
